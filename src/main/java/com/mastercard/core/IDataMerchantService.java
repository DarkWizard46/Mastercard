...
public interface IDataMerchantService<T> {
    ...
    public ResponseEntity<Object> update(Long merchantId, T t, HttpServletRequest request);// 011-020

//    public ResponseEntity<Object> delete(Long merchantId, HttpServletRequest request);// 021-030

    public ResponseEntity<Object> findAll(Pageable pageable, HttpServletRequest request);// 031-040

    public ResponseEntity<Object> findById (Long merchantId);// 041-050
...
//
//    public void downloadReportExcel(String filterBy, String value, HttpServletRequest request,
//                                    HttpServletResponse response);// 071-080
//
//    public void addFile(Long merchantId, String documentFile);
